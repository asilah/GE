...
<body class="nav-md">
<% session.setAttribute("page","updateDept");%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>
                                        Modifier un Département <small></small>
                                    </h2>
                                ...
                                <f:form modelAttribute="DeptForm" action="updateDept" method="post" class="form-horizontal form-label-left" >
                                        <span class="section">Département</span>
                                        
                                      
                                        <div id="neww">
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nom">code Departement <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="code" value="${dept.codeDept}" class="form-control col-md-7 col-xs-12"  disabled="disabled"  name="codeDept" placeholder="nom exp Informatique" required="required" type="text" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="nom" value="${dept.nom}" class="form-control col-md-7 col-xs-12"  name="nom" placeholder="nom exp Informatique" required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="ville" name="ville" value="${dept.ville}" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea class="form-control" name="description"  rows="3" placeholder="description">${dept.description} </textarea> </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="chefDept">chef du Département <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" name="chefDept" value="${dept.chefDept.codeEmp}" id="autocomplete-custom-append" class="form-control col-md-12" style="float: left;" />
                                            </div>
                                        </div>
