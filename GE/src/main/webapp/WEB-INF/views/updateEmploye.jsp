...
<body class="nav-md">
<% session.setAttribute("page","updateEmp");%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <f:form modelAttribute="EmpForm" action="updateEmp" method="post" class="form-horizontal form-label-left" >
                                        <span class="section">Département</span>
                         				 <div id="neww">
                                         <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >code Employe <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input name="codeEmp" value="${emp.codeEmp}" class="form-control col-md-7 col-xs-12"  required="required" type="text" >
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input  value="${emp.cin}" name="cin" class="form-control col-md-7 col-xs-12" required="required" type="text" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >numCnss <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input  value="${emp.numCnss}" name="numCnss" class="form-control col-md-7 col-xs-12"    required="required" type="text" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input value="${emp.nom}" name="nom" class="form-control col-md-7 col-xs-12"    required="required" type="text" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input value="${emp.prenom}" name="prenom" class="form-control col-md-7 col-xs-12"    required="required" type="text" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="ville" value="${emp.ville}" class="form-control col-md-7 col-xs-12"  name="ville"  required="required" type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="address" name="address" value="${emp.address}" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                         <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="tel" name="tel" value="${emp.tel}" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input value="${emp.mail}" name="mail" class="form-control col-md-7 col-xs-12"    required="required" type="mail" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                    ...
                                                    <f:select path="Departement" class=" form-control col-md-7 col-xs-12" required="required">
                                                        <option value="${emp.departement.codeDept }">${emp.departement.nom }</option>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >responsabilite <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input value="${emp.responsabilite}" name="responsabilite" class="form-control col-md-7 col-xs-12"    required="required" type="text" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >banque <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="banque" value="${emp.banque}" class="form-control col-md-7 col-xs-12"    name="banque"  required="required" type="text" >
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >numCompteBanque <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="numCompteBanque" value="${emp.numCompteBanque}" class="form-control col-md-7 col-xs-12"    name="numCompteBanque"  required="required" type="text" >
                                            </div>
                                        </div>
                                       <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >salBase <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="salBase" value="${emp.salBase}" class="form-control col-md-7 col-xs-12"    name="salBase"  required="required" type="text" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <f:select path="situationFamiliale" id="situation" class="form-control">
                                                            <option value="${emp.situationFamiliale}">${emp.situationFamiliale}</option>
                                                            <option value="Céblibataire">Céblibataire</option>
                                       ...
                                       <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >nbEnfant <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input value="${emp.nbEnfant}" name="nbEnfant" class="form-control col-md-7 col-xs-12"    required="required" type="number" data-inputmask="'mask' : '99'" >
                                            </div>
                                        </div>
