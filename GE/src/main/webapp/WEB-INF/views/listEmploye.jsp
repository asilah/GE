        ...
        <div class="main_container">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="<c:url value="/index"/>"><i class="fa fa-univerity"></i> <span>Home</span></a>
                    </div>
            ...
            <div class="right_col" role="main">
                <div class="">
                    ...
                    <small>
                        Liste employés de l'entreprise
                    </small>
                </h3>
                        </div>
                                    ...
                                    <table id="example" class="table table-striped responsive-utilities jambo_table">
                                       ...
                                       <tbody>
                                            ...
                                            <tr class="odd pointer">
                                                ...
                                                <td class=" ">${lemp.nom } ${lemp.prenom }</td>
                                                <td class=" ">${lemp.numCnss } </td>
                                                <td class=" ">${lemp.responsabilite } </td>
                                                <td class=" ">${lemp.employeSup.nom } </td> 
                                                <td class=" ">${lemp.dateEntre } </td>
                                                <td class=" ">${lemp.tel } </td>
                                                <td class=" ">${lemp.mail } </td>
                                                <td class=" ">${lemp.address } </td>
                                                <td>
                                                
                                                
                                                <div class="btn-group  btn-group-sm">
                                                <div class="col-xs-12 col-sm-6 emphasis">
                                                      <f:form modelAttribute="EmpForm" action="AfficheEmp" method="post" >
                                                      	<input name="codeEmp" value="${lemp.codeEmp }" type="hidden"/>
                                                      	
                                                        <button  type="submit"  class="btn btn-primary btn-xs btn-default"><i class="fa fa-folder"></i> A </button>
                                                         </f:form>   
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6 emphasis">
                                                      <f:form modelAttribute="EmpForm" action="updateEmp" method="post" >
                                                      	<input name="codeEmp" value="${lemp.codeEmp }" type="hidden"/>
                                                      	
                                                        <button  type="submit"  class="btn btn-info btn-xs btn-default"> <i class="fa fa-trash-o"></i> M </button>
                                                         </f:form>  
                                                 </div>
                                               </div>
                                                </td>                                      		
                ...
                <footer>
                    <div class="">
                        <p class="pull-right"> 
                            <span class="lead"> <i class="fa fa-univesity"></i> Projet-Jee-2016</span>
                        </p>
                    </div>
                    <div class="clearfix"></div>
                </footer>
